 ...
 * Use this to allow your users to configure the {@link net.silthus.art.api.ARTObject} without a key.
 * <br>
 *  Any fields not annotated with a {@link Position} must be provided as key value pair.
 *  An {@link net.silthus.art.api.parser.ARTParseException} will be thrown if there are any fields with the same position.
