...
class RequirementParserTest {
    ...
    void beforeEach() {
        ...
        when(factory.create(any())).thenAnswer(invocation -> new DefaultRequirementContext<>(Object.class, (o, context) -> true, invocation.getArgument(0), mock(Storage.class)));
    ...
    class parse {
        ...
        void shouldMatchActionIdentifier() {
            ...
            assertThat(parser.parse()).extracting(DefaultRequirementContext::getConfig)
