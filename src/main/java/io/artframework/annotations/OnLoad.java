 ...
 *     <li>a config class that should be parsed from a file config annotated with @{@link Config}
 * </ul>
 * <p>
 ...
 *      @OnLoad
 *      public void onLoad(Configuration art, @Config("my-module.yml") MyConfig config) {
 *          ...
 *      }
 * }
 * }
