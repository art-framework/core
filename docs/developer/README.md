...
dependencies {
    implementation group: 'net.silthus.art', name: 'art-core', version: '1.0.0-alpha.1-beta.1'
}
```
...
```gradle
plugins {
    id 'com.github.johnrengelman.shadow' version '1.0.0-alpha.1'
}
...
<project>
  ...
  <dependencies>
    <dependency>
      ...
      <version>1.0.0-alpha.1-beta.1</version>
    </dependency>
  </dependencies>
  ...
</project>
