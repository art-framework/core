 ...
 */
public class RequirementWrapper<TTarget, TConfig> extends AbstractArtObjectContext<TTarget, TConfig, RequirementConfig<TConfig>> implements Requirement<TTarget, TConfig> {

    @Getter
    private final Requirement<TTarget, TConfig> requirement;

    public RequirementWrapper(Class<TTarget> targetClass, Requirement<TTarget, TConfig> requirement, RequirementConfig<TConfig> config, Storage storage) {
    ...
    @Override
    public boolean test(@NonNull Target<TTarget> target, RequirementWrapper<TTarget, TConfig> context) {
