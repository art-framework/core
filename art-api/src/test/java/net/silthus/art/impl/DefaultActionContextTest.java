...
public class DefaultActionContextTest {
    ...
    private DefaultActionContext<String, String> context;
    ...
    public void beforeEach() {
        ...
        this.context = spy(new DefaultActionContext<>(String.class, action, new ActionConfig<>(), null, storage));
    }
    ...
    class constructor {
        ...
        void shouldThrowIfRequirementIsNull() {
            ...
            assertThatExceptionOfType(NullPointerException.class)
                    .isThrownBy(() -> new DefaultActionContext<>(null, action, new ActionConfig<>(), null, mock(Storage.class)));
        }
        ...
        void shouldThrowIfTargetClassIsNull() {
            ...
            assertThatExceptionOfType(NullPointerException.class)
                    .isThrownBy(() -> new DefaultActionContext<>(String.class, null, new ActionConfig<>(), null, mock(Storage.class)));
        }
        ...
        void shouldThrowIfConfigIsNull() {
            ...
            assertThatExceptionOfType(NullPointerException.class)
                    .isThrownBy(() -> new DefaultActionContext<>(String.class, action, null, null, mock(Storage.class)));
        }
    }
    ...
    public class Execute {
        ...
        public void shouldCallActionContextExecute() {
            ...
            DefaultActionContext<String, String> spyContext = spy(context);
        ...
        void shouldVerfiyIfTargetTypeMatches() {
            ...
            DefaultActionContext context = DefaultActionContextTest.this.context;
        ...
        class withDelay {
            ...
            void beforeEach() {
                ...
                context = new DefaultActionContext<>(String.class, action, new ActionConfig<>(), scheduler, mock(Storage.class));
            }
            ...
            void shouldExecuteActionDirectlyIfSchedulerIsNotLoaded() {
                ...
                context = new DefaultActionContext<>(String.class, action, new ActionConfig<>(), null, mock(Storage.class));
    ...
    class executeWithContext {
        ...
        void shouldThrowIfExecuteWithContextIsCalledDirectly() {
            ...
            assertThatExceptionOfType(UnsupportedOperationException.class)
                    .isThrownBy(() -> context.execute(new StringTarget("foobar"), new DefaultActionContext<>(String.class, (s, s2) -> {
